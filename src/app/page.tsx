    ...
    <main className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="bg-blue-600 text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
          <div className="text-4xl font-semibold">Vincenzo Barager</div>
          ...
          <nav className="flex flex-wrap items-center justify-end gap-2 font-semibold">
            ...
            {/* Put your resume PDF in: public/Vincenzo-Barager-Resume.pdf */}
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 space-y-16">
        ...
        {/* ===== HERO (FULL WIDTH MARGINS + CLEAN CENTER COLUMN) ===== */}
...
<div className="pointer-events-none absolute inset-0 z-0 hidden xl:block">
  {/* Left circle */}
  <div
    className="absolute h-[360px] w-[360px] rounded-full bg-blue-700"
...
<div
    className="absolute h-[150px] w-[150px] rounded-full bg-blue-700"
    style={{ right: 300, bottom: 90 }}
  />
</div>
  ...
  <div className="relative z-10 mx-auto max-w-7xl px-6 py-12">
    <header className="flex flex-col items-center gap-10 md:flex-row md:items-start">
      <Image
        ...
        width={320}
        height={410}
        className="h-[410px] w-[320px] rounded-full border-4 border-blue-700 object-cover"
        priority
      />

      <div className="space-y-10 md:pt-6">
        <h1 className="text-4xl font-semibold tracking-tight text-blue-700 sm:text-5xl">
          Computer Science student building things.
        </h1>

        <p className="max-w-3xl text-2xl leading-relaxed text-blue-500">
        ...
        {/* ===== PROJECTS (FULL WIDTH + TRIANGLE MARGINS) ===== */}
<section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen overflow-hidden bg-white">
 {/* Margin triangles */}
<div className="pointer-events-none absolute inset-0 z-0 hidden lg:block">
  ...
  <div
    className="absolute h-0 w-0
      border-t-[140px] border-b-[140px] border-l-[200px]
      border-t-transparent border-b-transparent border-l-purple-500"
    style={{ top: 160, left: 100, transform: "rotate(70deg)" }}
  />

  {/* Right triangle */}
  <div
    className="absolute h-0 w-0
      border-t-[140px] border-b-[140px] border-r-[200px]
  ...
  {/* Centered content */}
  <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 space-y-6">
    <h2 className="text-4xl font-semibold text-purple-700 border-l-4 border-purple-600 pl-4">
      Projects
    </h2>
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      />
        ...
        {/* ===== EXPERIENCE (FULL WIDTH + SQUARE MARGINS) ===== */}
<section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen overflow-hidden bg-white">
  {/* Margin squares */}
<div className="pointer-events-none absolute inset-0 z-0 hidden xl:block">
  <div
    className="absolute h-[200px] w-[200px] bg-red-500"
    style={{ top: 40, left: 75, transform: "rotate(8deg)" }}
  />

  <div
    className="absolute h-[160px] w-[160px] bg-red-600"
    style={{ top: 120, right: 150, transform: "rotate(-6deg)" }}
  />

  <div
    className="absolute h-[160px] w-[160px] bg-red-600"
    style={{ top: 490, right: 50, transform: "rotate(46deg)" }}
  />
</div>
  ...
  {/* Centered content */}
  <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 space-y-6">
    <h2 className="text-4xl font-semibold text-red-600 border-l-4 border-red-600 pl-4">
      Experience
    </h2>
    ...
    <div className="space-y-4">
        ...
        <footer className="mt-5 bg-red-400 text-white">
          <div className="mx-auto max-w-7xl px-6 py-10 space-y-7">
            {/* Contact */}
...
function ExperienceItem({
  ...
  return (
    <div className="rounded-2xl border border-red-700 bg-white p-5 transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-sm">
      ...
      <ul className="mt-3 list-disc space-y-1 pl-5 text-lg text-zinc-700">
        {bullets.map((b) => (
          <li key={b}>{b}</li>
        ))}
      </ul>
...
function ProjectCard({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 bg-white p-5 transition-all duration-200 ease-out hover:-translate-y-1 hover:border-purple-400 hover:shadow-sm">
...
<h3 className="text-base font-semibold">
      ...
      <p className="mt-2 text-lg text-zinc-700">{desc}</p>

      <div className="mt-4 flex flex-wrap gap-2">
        {tags.map((t) => (
          <span
            key={t}
            className="rounded-full border border-purple-200 bg-purple-50 px-2.5 py-1 text-sm text-purple-700"
          >
            {t}
          </span>
        ))}
